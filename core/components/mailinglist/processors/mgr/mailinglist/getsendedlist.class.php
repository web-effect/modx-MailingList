...
class MailingListGetSendedProcessor extends modProcessor
{
	...
	public function setToLog($value)
	{
		...
		ob_end_clean();
		file_put_contents(dirname(__FILE__).'/MailingListGetSendedProcessor.log',$value,FILE_APPEND);
	}
}

return 'MailingListGetSendedProcessor';